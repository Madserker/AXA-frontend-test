...
define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/DetailsList"], function (require, exports, tslib_1, React, DetailsList_1) {
    ...
    var DetailsListCustomFooterExample = /** @class */ (function (_super) {
        ...
        function DetailsListCustomFooterExample() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        DetailsListCustomFooterExample.prototype.render = function () {
            return (React.createElement(DetailsList_1.DetailsList, { items: _items, columns: _columns, setKey: "set", layoutMode: DetailsList_1.DetailsListLayoutMode.fixedColumns, selectionPreservedOnEmptyClick: true, ariaLabelForSelectionColumn: "Toggle selection", ariaLabelForSelectAllCheckbox: "Toggle selection for all items", onRenderDetailsFooter: this._onRenderDetailsFooter }));
        };
