define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/DetailsList", "office-ui-fabric-react/lib/utilities/exampleData", "office-ui-fabric-react/lib/Styling"], function (require, exports, tslib_1, React, Link_1, DetailsList_1, exampleData_1, Styling_1) {
    "use strict";
    ...
    var GROUP_COUNT = 20;
    var _items = exampleData_1.createListItems(500);
    var _groups = exampleData_1.createGroups(GROUP_COUNT, 1, 0, ITEMS_PER_GROUP);
    var DetailsListCustomGroupHeadersExample = /** @class */ (function (_super) {
        ...
        DetailsListCustomGroupHeadersExample.prototype.render = function () {
            return (React.createElement(DetailsList_1.DetailsList, { items: _items, groups: _groups, groupProps: {
