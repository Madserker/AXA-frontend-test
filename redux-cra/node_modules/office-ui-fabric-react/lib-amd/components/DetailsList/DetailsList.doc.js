define(["require", "exports", "react", "./DetailsList.checklist", "./examples/DetailsList.Basic.Example", "./examples/DetailsList.Compact.Example", "./examples/DetailsList.CustomColumns.Example", "./examples/DetailsList.CustomRows.Example", "./examples/DetailsList.CustomGroupHeaders.Example", "./examples/DetailsList.Advanced.Example", "./examples/DetailsList.Grouped.Example", "./examples/DetailsList.Grouped.Large.Example", "./examples/DetailsList.DragDrop.Example", "./examples/DetailsList.Documents.Example", "./examples/DetailsList.NavigatingFocus.Example", "../Shimmer/examples/Shimmer.Application.Example", "./examples/DetailsList.CustomFooter.Example"], function (require, exports, React, DetailsList_checklist_1, DetailsList_Basic_Example_1, DetailsList_Compact_Example_1, DetailsList_CustomColumns_Example_1, DetailsList_CustomRows_Example_1, DetailsList_CustomGroupHeaders_Example_1, DetailsList_Advanced_Example_1, DetailsList_Grouped_Example_1, DetailsList_Grouped_Large_Example_1, DetailsList_DragDrop_Example_1, DetailsList_Documents_Example_1, DetailsList_NavigatingFocus_Example_1, Shimmer_Application_Example_1, DetailsList_CustomFooter_Example_1) {
    ...
    var DetailsListBasicExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/DetailsList/DetailsList.Basic.Example.Codepen.txt');
    ...
    var DetailsListCompactExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/DetailsList/DetailsList.Compact.Example.Codepen.txt');
    ...
    var DetailsListGroupedExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/DetailsList/DetailsList.Grouped.Example.Codepen.txt');
    ...
    var DetailsListGroupedLargeExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/DetailsList/DetailsList.Grouped.Large.Example.Codepen.txt');
    ...
    var DetailsListNavigatingFocusExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/DetailsList/DetailsList.NavigatingFocus.Example.Codepen.txt');
    ...
    var DetailsListCustomFooterExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/DetailsList/DetailsList.CustomFooter.Example.Codepen.txt');
