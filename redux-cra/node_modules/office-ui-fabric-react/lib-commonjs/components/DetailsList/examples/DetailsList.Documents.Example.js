...
var DetailsListDocumentsExample = /** @class */ (function (_super) {
    ...
    DetailsListDocumentsExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(Toggle_1.Toggle, { className: classNames.exampleToggle, label: "Enable compact mode", checked: isCompactMode, onChange: this._onChangeCompactMode, onText: "Compact", offText: "Normal" }),
            React.createElement(Toggle_1.Toggle, { className: classNames.exampleToggle, label: "Enable modal selection", checked: isModalSelection, onChange: this._onChangeModalSelection, onText: "Modal", offText: "Normal" }),
            React.createElement("div", { className: classNames.exampleChild }, selectionDetails),
            React.createElement(TextField_1.TextField, { className: classNames.exampleChild, label: "Filter by name:", onChange: this._onChangeText }),
