let { Checkbox, ICheckboxProps, Fabric } = window.Fabric;

interface ICheckboxBasicExampleState {
  isChecked: boolean;
}

class CheckboxImplementationExamples extends React.Component<{}, ICheckboxBasicExampleState> {
  constructor(props: {}) {
    super(props);
...
ReactDOM.render(<CheckboxImplementationExamples />, document.getElementById('content'));
