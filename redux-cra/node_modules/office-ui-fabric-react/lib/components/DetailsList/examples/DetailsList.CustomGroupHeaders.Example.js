...
var GROUP_COUNT = 20;
var _items = createListItems(500);
var _groups = createGroups(GROUP_COUNT, 1, 0, ITEMS_PER_GROUP);
var DetailsListCustomGroupHeadersExample = /** @class */ (function (_super) {
    ...
    DetailsListCustomGroupHeadersExample.prototype.render = function () {
        return (React.createElement(DetailsList, { items: _items, groups: _groups, groupProps: {
