...
var DocumentCardBase = /** @class */ (function (_super) {
    ...
    DocumentCardBase.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: this._rootElement, tabIndex: tabIndex, "data-is-focusable": actionable, role: role, className: this._classNames.root, onKeyDown: actionable ? this._onKeyDown : undefined, onClick: actionable ? this._onClick : undefined, style: style }, children));
    };
