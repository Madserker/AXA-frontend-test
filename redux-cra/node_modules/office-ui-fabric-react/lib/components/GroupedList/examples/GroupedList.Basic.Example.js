...
var GroupedListBasicExample = /** @class */ (function (_super) {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement(FocusZone, null,
                React.createElement(SelectionZone, { selection: this._selection, selectionMode: SelectionMode.multiple },
                    React.createElement(GroupedList, { items: _items, onRenderCell: this._onRenderCell, selection: this._selection, selectionMode: SelectionMode.multiple, groups: _groups, compact: isCompactMode })))));
    };
    GroupedListBasicExample.prototype._onRenderCell = function (nestingDepth, item, itemIndex) {
        ...
        return (React.createElement(DetailsRow, { columns: Object.keys(item)
            ...
            }), groupNestingDepth: nestingDepth, item: item, itemIndex: itemIndex, selection: selection, selectionMode: SelectionMode.multiple, compact: this.state.isCompactMode }));
    };
