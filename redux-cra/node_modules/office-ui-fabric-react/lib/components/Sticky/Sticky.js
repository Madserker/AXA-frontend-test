...
var Sticky = /** @class */ (function (_super) {
    ...
    Sticky.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        function isHeightOrWidthDifferent(a, b) {
            return (a &&
                b &&
                a.current &&
                b.current &&
                (a.current.offsetHeight !== b.current.offsetHeight || a.current.scrollWidth !== b.current.scrollWidth));
        }
        ...
        return (isStickyTop !== nextState.isStickyTop ||
            ...
            isHeightOrWidthDifferent(this._nonStickyContent, this._placeHolder) ||
            isHeightOrWidthDifferent(this._nonStickyContent, this._stickyContentTop) ||
            isHeightOrWidthDifferent(this._nonStickyContent, this._stickyContentBottom));
    };
